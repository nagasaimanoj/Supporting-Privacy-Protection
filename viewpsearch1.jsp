...
<body bgcolor=#FFFFFF >
<p align="center" class="style1"><em><strong>Comparison Between Greedy DP and Greedy IL !!</strong></em>! </p>
<p align="center" class="style1"><img src="Compare.jpg" width="300" height="80"></p>
...
String uname=(String)application.getAttribute("uname");
      	...
      	try 
	{
           ...
           String query="select * from search1 where uname='"+uname+"' "; 
