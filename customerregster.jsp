...
st.executeUpdate("insert into  user (uname,password,email,mobile,location,dob,address,gender,pincode,sk1,sk2) values ('"+cname+"','"+pass+"','"+email+"','"+mobile+"','"+loca+"','"+dob+"','"+add+"','"+gen+"','"+pin+"','Rejected','Rejected')");
